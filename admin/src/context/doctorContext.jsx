...
const DoctorContextProvider = (props) => {
    ...
    const getAppointments = async () => {
        try {
            ...
            if (data.success) {
                ...
                toast.error('Appointments not fetched')
            }
    ...
    const updateProfileData = async (profileUpdateData) => {
        try {
            const { data } = await axios.post(backendUrl + '/api/doctor/update-profile', profileUpdateData, {
                headers: { dtoken: dToken }
            })
            if (data.success) {
                toast.success(data.message)
