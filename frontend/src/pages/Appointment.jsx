  ...
  return docInfo && (
    <div className='md:mx-10'>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-gray-700'>
        ...
        {/* Action Book Button */}
        <button className='bg-primary text-white text-sm font-normal px-14 py-3 rounded-full my-6 hover:scale-105 transition-all duration-300 cursor-pointer shadow-sm hover:bg-opacity-95'>
          Book an appointment
        </button>
      </div>
